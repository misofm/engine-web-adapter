...
`@misofm/engine@0.2.6`. Version 0.5 identifies canonical PCM with BLAKE3-256 and streams standards-compliant native FLAC
...
```sh
npm install @misofm/engine-web-adapter@0.5.8 @misofm/engine@0.2.6
```

The package is ESM-only and remains pinned to exactly Engine `0.2.6` and
...
The integration uses the published Engine 0.2.6 archive
from commit `cdf629d6bfd0224b3532dd0abd04b9581240da56`, SHA256
