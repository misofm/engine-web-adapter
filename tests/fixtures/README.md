# Dense FLAC browser fixture

`dense-silence.flac` is a 206-byte, fixed-block mono PCM16 fixture containing
2,048 zero frames at 48 kHz. It was generated with Xiph FLAC 1.5.0 using a
512-frame block size and one seek point per encoded frame. Its SEEKTABLE is
...
- Encoder: Xiph FLAC 1.5.0 (`--blocksize=512`, dense seek points, no padding)
